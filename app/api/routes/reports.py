...
from app.services.commands.report_commands import ReportCommandService
...
def upload_report_file(
    ...
    return ReportCommandService.upload_report_file(
        db,
        task_id=task_id,
        notes=notes,
        ...
        employee=employee,
        principal=principal,
        get_accessible_task_or_404=_get_accessible_task_or_404,
        to_report_file_response=_to_report_file_response,
...
def get_report_job_status(
    ...
    return ReportJobQueryService.get_report_job_status(
        db,
        job_id=job_id,
        principal=principal,
        job_service=job_service,
        assert_job_access=_assert_job_access,
        to_response=_to_report_job_status_response,
    )
...
def generate_report(
    ...
    return ReportCommandService.generate_report(
        db,
        payload=payload,
        employee=employee,
        principal=principal,
        ...
        log_service=LogService,
        cache_backend=cache,
        queue_task=generate_engineer_report_task,
        logger=logger,
    )
...
def generate_report_delayed(
    ...
    return ReportCommandService.generate_report_delayed(
        db,
        payload=payload,
        employee=employee,
        principal=principal,
